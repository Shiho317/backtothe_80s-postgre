  ...
  return (
    <div className="bg-events-bg bg-cover bg-center w-full h-screen flex flex-col items-center">
      ...
      <div className='fixed gap-2 bottom-2 right-2 flex flex-col justify-center lg:gap-6 lg:top-1/2 lg:-translate-y-1/2 lg:right-10'>
        <Link to='/login'>
          <button className='bg-none border border-black bg-white py-1 w-24 text-lg lg:text-xl hover:bg-red-500 lg:py-2 lg:w-36'>Host</button>
        </Link>
        <Link to='/'>
          <button className='bg-none border border-black bg-white py-1 w-24 text-lg lg:text-xl hover:bg-red-500 lg:py-2 lg:w-36'>Home</button>
        </Link>
      </div>
    </div>
  );
